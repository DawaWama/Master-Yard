    ...
    var roadAsphaltPavingContent =
      ...
      '<div class="service-types">' +
        '<article class="service-type">' +
          '<img class="service-type-image" src="asphaltSizes/1.png" alt="Асфальтирование на готовом основании" />' +
        ...
        '</article>' +
        '<article class="service-type">' +
          '<img class="service-type-image" src="asphaltSizes/2.png" alt="Асфальтирование с выравнивающим слоем" />' +
        ...
        '</article>' +
        '<article class="service-type">' +
          '<img class="service-type-image" src="asphaltSizes/3.png" alt="Асфальтирование по щебёночному основанию" />' +
        ...
        '</article>' +
        '<article class="service-type">' +
          '<img class="service-type-image" src="asphaltSizes/4.png" alt="Асфальтирование по щебёночно-песчаному основанию" />' +
