    ...
    var roadAsphaltPavingContent =
      ...
      '<div class="service-types">' +
        '<article class="service-type">' +
          '<img class="service-type-image" src="asphaltSizes/1_2.png" alt="Асфальтирование на готовом основании" />' +
        ...
        '</article>' +
        '<article class="service-type">' +
          '<img class="service-type-image" src="asphaltSizes/2_2.png" alt="Асфальтирование с выравнивающим слоем" />' +
        ...
        '</article>' +
        '<article class="service-type">' +
          '<img class="service-type-image" src="asphaltSizes/3_2.png" alt="Асфальтирование по щебёночному основанию" />' +
        ...
        '</article>' +
        '<article class="service-type">' +
          '<img class="service-type-image" src="asphaltSizes/4_2.png" alt="Асфальтирование по щебёночно-песчаному основанию" />' +
